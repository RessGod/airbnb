 ...
 * @UniqueEntity(
 *  fields = {"email"},
 *  message = "Une autre utilisateur possède déjà cet email, merci de le modifier"
 * )
 */
class User implements UserInterface
{
    ...
    // AJout du variable pour la confirmation du mot de passe
    /**
    ...
    // Fonction a rajouter après avoir implémenter UserInterface
