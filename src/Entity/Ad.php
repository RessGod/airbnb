...
class Ad
{
     ...
     * @Assert\Length(min=10, minMessage="Votre titre doit doit faire plus de 10 caractères")
     */
    private $title;
    ...
    // Pour avoir les commentaire fait par l'auteur
    ...
    // Pour avoir la moyenne général des toutes les annonces 
